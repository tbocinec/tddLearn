<div class="menu">
    <ul class="list">
        ...
        <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-city-alt"></i><span>Others</span> </a>
            <ul class="ml-menu">
                <li><a href="departments.html">Course category</a></li>
                <li><a href="add-departments.html">Programing language</a></li>
            </ul>
        </li>
